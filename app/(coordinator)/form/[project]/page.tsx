            ...
            {fields.length === 0 ? (
              ...
              fields.map((field) => (
                <div key={field.id} className="pt-6">
                  ...
                  {/* Final fallback: If any field type somehow doesn't match, still render a text input */}
                  {field.type !== "text" &&
                    field.type !== "number" &&
                    field.type !== "textarea" &&
                    field.type !== "rating" &&
                        ...
                        (_, i) => {
                          ...
                          return (
                            <button
                              ...
                              className={`rounded-sm p-2 transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-[#004446] ${
                                isActive
                                  ? "text-slate-700"
